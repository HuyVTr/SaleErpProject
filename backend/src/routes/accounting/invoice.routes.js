...
import { 
  ...
  updateInvoiceStatus, 
  updateInvoiceCosts 
} from "../../controllers/accounting/invoice.controller.js";
...
router.put("/:id/status", protect, authorize(1), updateInvoiceStatus);
router.put("/:id/costs", protect, authorize(1), updateInvoiceCosts);
